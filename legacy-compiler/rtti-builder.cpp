   ...
   names_(names)
{
    ...
    classdefs_ = new SmxRttiTable<smx_rtti_classdef_v1>("rtti.classdefs");
...
{
    assert(fun->cg()->pcode_end > static_cast<uint32_t>(fun->cg()->label.offset()));
