...
struct FpuRegister {
    const char* name() const {
        static const char* names[] = {"st0", "st1", "st2", "st3", "st4", "st5", "st6", "st7"};
        return names[code];
    }
...
enum Scale { NoScale, ScaleTwo, ScaleFour, ScaleEight, ScalePointer = ScaleFour };
...
class Assembler : public AssemblerBase
{
  ...
  private:
    ...
    void emit3(uint8_t prefix1, uint8_t prefix2, uint8_t opcode, uint8_t reg,
