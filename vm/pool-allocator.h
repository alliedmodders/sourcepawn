...
template <typename T>
class PoolList : public std::vector<T, PoolAllocationPolicy>, public PoolObject
{
  public:
    PoolList()
...
template <typename T>
class FixedPoolList : public FixedArray<T, PoolAllocationPolicy>, public PoolObject
{
  public:
