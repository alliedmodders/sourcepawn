...
int
PluginContext::StringToLocalUTF8(cell_t local_addr, size_t maxbytes, const char* source,
                                 size_t* wrtnbytes) {
    char* dest;
    size_t len;
...
bool
PluginContext::Invoke(funcid_t fnid, const cell_t* params, unsigned int num_params,
                      cell_t* result) {
...
cell_t*
PluginContext::heapAllocEx(cell_t amount, cell_t* out) {
...
bool
PluginContext::initArray(cell_t array_addr, cell_t dat_addr, cell_t iv_size, cell_t data_copy_size,
...
cell_t
PluginContext::GetNullFunctionValue() {
...
bool
PluginContext::IsNullFunctionId(funcid_t func) {
    return func == GetNullFunctionValue();
}

bool
PluginContext::GetFunctionByIdOrNull(funcid_t func, IPluginFunction** out) {
...
IPluginFunction*
PluginContext::GetFunctionByIdOrError(funcid_t func_id) {
