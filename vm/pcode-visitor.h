...
class PcodeVisitor
{
 public:
  ...
  virtual bool visitSDIV_ALT_I64(cell_t pri_slot) = 0;
  virtual bool visitSMOD_ALT_I64(cell_t pri_slot) = 0;
  ...
  virtual bool visitDIV_ALT_F32() = 0;
  virtual bool visitADD_F32() = 0;
  virtual bool visitSUB_ALT_F32() = 0;
