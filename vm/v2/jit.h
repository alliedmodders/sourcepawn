...
class CompilerBase
{
  ...
  protected:
    ...
    virtual void EmitGetFnObj(uint16_t src_reg, const TypeDesc* td, uint16_t dest_reg) = 0;
    ...
    virtual void EmitFillArray(uint16_t addr_reg, const void* data, uint32_t data_size,
